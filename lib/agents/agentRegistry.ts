...
export const AGENT_REGISTRY: RegisteredAgent[] = [
  ...
  },
  {
    ...
    emoji: "📚",
    kind: "reasoning",
    file: "lib/agents/retrievalAgent.ts",
    role: "Grounds every result in a curated oral-cancer knowledge base and returns the supporting snippets.",
    pattern: "OpenClaw: skill/knowledge files the agent consults at runtime",
  },
  {
